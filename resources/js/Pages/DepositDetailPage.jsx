...
const DepositDetailPage = () => {
    const { deposit } = usePage().props;
    const detail = deposit;
    ...
    return (
        <div>
            <Link href="/deposits" className="flex items-center gap-2 text-gray-600 hover:text-gray-900 mb-6"><ArrowLeft size={20} /><h1 className="text-2xl font-bold text-gray-800">Detail Deposito</h1></Link>
