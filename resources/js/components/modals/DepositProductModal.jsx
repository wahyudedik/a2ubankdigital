...
const DepositProductModal = ({ product, onClose, onSave }) => {
    ...
    const [formData, setFormData] = useState({ product_name: '', interest_rate_pa: '', tenor_months: '', min_amount: '', is_active: 1 });
    const isEditing = !!product;
    useEffect(() => { if (isEditing) setFormData(product); }, [product, isEditing]);
