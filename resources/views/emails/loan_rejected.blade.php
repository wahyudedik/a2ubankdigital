...
<body>
    <div style="display:none; max-height:0; overflow:hidden;">{{ $preheader ?? 'Pengajuan pinjaman Anda ditolak.' }}</div>
    <div class="container">
        <div class="header">
        ...
        <div class="content">
            ...
            <span class="badge">✗ Pinjaman Ditolak</span>
            <p>Mohon maaf, pengajuan pinjaman Anda tidak dapat kami setujui saat ini.</p>
            <div class="info-box">
                <div class="info-row">
            ...
            <p>Anda dapat mengajukan kembali setelah memenuhi persyaratan yang diperlukan. Hubungi Customer Service kami untuk informasi lebih lanjut.</p>
            <br>
