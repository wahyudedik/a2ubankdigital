...
<head>
    ...
    <title>Isi Saldo Disetujui</title>
    <style>
...
<body>
    <div style="display:none; max-height:0; overflow:hidden;">{{ $preheader ?? 'Isi saldo Anda telah disetujui.' }}</div>
    <div class="container">
        <div class="header">
        ...
        <div class="content">
            ...
            <span class="badge">✓ Isi Saldo Disetujui</span>
            <p>Permintaan isi saldo Anda telah <strong>disetujui</strong> dan saldo telah ditambahkan ke rekening Anda.</p>
            ...
            <div class="info-box">
                ...
                <div class="info-row">
                    <span class="label">Tanggal Diproses</span>
